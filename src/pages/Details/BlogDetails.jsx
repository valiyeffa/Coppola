    ...
    return (
        <div className='blog-detail details'>
            <div className="page-title">
                <p>Movies / {blogDetID?.category} / {blogDetID?.title}</p>
            </div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row blog-body">
                        <div className="blog-detail-body">
                            ...
                            <Link to='/blog' onClick={() => window.scrollTo(0, 0)} className='btn back-pg'>Back To Page</Link>
                        ...
                        <div className="reviews">
                            ...
                            <div className="reviews-body">
                                <div className="reviews-body_title">
                                    <p>2 comments for {blogDetID?.title}</p>
                                </div>
